...
public class VillagerViewType implements IEivRecipeViewType {
    ...
    private static final ResourceLocation VILLAGER_LOCATION = new ResourceLocation(CommonEIV.MODID, "textures/gui/type/villager.png");
    private static final ResourceLocation CHAT_BACKGROUND = new ResourceLocation(CommonEIV.MODID, "textures/gui/embeddings/container/villager.png");
    ...
    public ResourceLocation getId() {
        return new ResourceLocation("villager_trading");
    }
